...
class Noticia(models.Model):
    ...
    conteudo = models.TextField('Conteúdo', null=True)
    data_da_criacao = models.DateField('Data da criação', blank= True, null=True)
    data_da_publicacao = models.DateField('Data da publicação', blank= True, null=True)
